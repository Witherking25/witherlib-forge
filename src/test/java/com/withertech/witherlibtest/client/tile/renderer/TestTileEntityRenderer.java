...
public class TestTileEntityRenderer extends TileEntityRenderer<TestTile>
{
    ...
    public TestTileEntityRenderer(TileEntityRendererDispatcher p_i226019_1_)
    {
        super(p_i226019_1_);
    }

    public void render(TestTile p_225616_1_, float p_225616_2_, MatrixStack p_225616_3_, IRenderTypeBuffer p_225616_4_, int p_225616_5_, int p_225616_6_)
    {
    ...
    private void renderCube(TestTile p_228883_1_, float p_228883_2_, float p_228883_3_, Matrix4f p_228883_4_, IVertexBuilder p_228883_5_)
    {
