...
public class ScreenUtils
{
    ...
    private static final ResourceLocation BUTTON_BACKGROUND = WitherLib.INSTANCE.MOD.modLocation("textures/gui/buttons.png");
    private static final ResourceLocation SCREEN_BACKGROUND = WitherLib.INSTANCE.MOD.modLocation("textures/gui/background.png");
