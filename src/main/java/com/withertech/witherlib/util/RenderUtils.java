...
public class RenderUtils
{
	...
	private static final RenderType LINES_NO_DEPTH = RenderType.create(
			...
			GL11.GL_LINES,
			128,
			RenderType.State.builder().setLineState(new RenderState.LineState(OptionalDouble.of(1))).setTransparencyState(
					TRANSLUCENT_TRANSPARENCY).setLayeringState(VIEW_OFFSET_Z_LAYERING).setWriteMaskState(new RenderState.WriteMaskState(
					true,
					false
