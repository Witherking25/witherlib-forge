...
public class ScreenUtils
{
    ...
    private static final ResourceLocation BUTTON_BACKGROUND = new ResourceLocation(WitherLib.MODID, "textures/gui/buttons.png");
    private static final ResourceLocation SCREEN_BACKGROUND = new ResourceLocation(WitherLib.MODID, "textures/gui/background.png");
